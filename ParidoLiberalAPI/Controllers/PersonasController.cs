...
using ParidoLiberalAPI.Models;
using System.Web.Http.Cors;


namespace ParidoLiberalAPI.Controllers
{
    public class PersonasController : ApiController
    {
        private DAM_InakiAlkiza_DEVEntities db = new DAM_InakiAlkiza_DEVEntities();

        // GET: api/Personas
        [EnableCors(origins: "*", headers: "*", methods: "*")] // aplicamos atributos cors
